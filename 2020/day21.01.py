...
i_a_tuples = [
    (set(line[:line.find(" (")].split()), set(line[line.find("(") + 10:line.find(")")].split(", ")))
    for line in lines]
...
for allergen in all_allergens:
    possible_ingredients = [ingredients for ingredients, allergens in i_a_tuples if allergen in allergens]
